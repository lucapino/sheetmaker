...
//
        ...
        To_Display += MI.Get(MediaInfo.StreamKind.General, 0, "Duration/String", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);

        int videoStreamNumber = MI.Count_Get(MediaInfo.StreamKind.Video);
        for (int i = 0; i < videoStreamNumber; i++) {
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Video, i, "Format", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Video, i, "Width", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Video, i, "Height", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Video, i, "FrameRate/String", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Video, i, "DisplayAspectRatio/String", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n-----------------------------------";
        }
        To_Display += "\n=======================================";
        int audioStreamNumber = MI.Count_Get(MediaInfo.StreamKind.Audio);
        for (int i = 0; i < audioStreamNumber; i++) {
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Audio, i, "Title", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Audio, i, "Codec", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Audio, i, "Channel(s)", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Audio, i, "SamplingRate/String", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n-----------------------------------";
        }
        To_Display += "\n=======================================";
        int textStreamNumber = MI.Count_Get(MediaInfo.StreamKind.Text);
        for (int i = 0; i < textStreamNumber; i++) {
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Text, i, "Title", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n" + MI.Get(MediaInfo.StreamKind.Text, i, "Language/String3", MediaInfo.InfoKind.Text, MediaInfo.InfoKind.Name);
            To_Display += "\n-----------------------------------";
        }
        To_Display += "\n=======================================";
        To_Display += "\r\n\r\nClose\r\n";
